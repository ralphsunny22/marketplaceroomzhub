...
<main class="main-wrapper">
    <div class="axil-single-product-area bg-color-white">
                            ...
                            <div class="col-lg-2 order-lg-1">
                                <div class="product-small-thumb small-thumb-wrapper small-thumb-style-two">
                                    ...
                                    @if (isset($alternate_images))
                                        @foreach(json_decode($product->alternate_images) as $alternate)
                                        <div class="small-thumb-img">
                                            <img src="{{ $alternate }}" alt="thumb image">
                                        </div>
                                        @endforeach
                                    @endif
                            ...
                            <div class="inner">
                                ...
                                <div class="product-action-wrapper d-flex-center">
                                    ...
                                    <div class="pro-qty mr--20">
                                        <input class="qty-val" type="text" value="{{ $cartProductQty }}">
                                    </div>
                                    <!-- End Quentity Action -->
                                    ...
                                    <ul class="product-action d-flex-center mb--0">
                                        ...
                                        <li class="wishlist d-none"><a href="wishlist.html" class="axil-btn wishlist-btn"><i class="far fa-heart"></i></a></li>
                                    </ul>
                                    <!-- End Product Action -->
        ...
        <div class="woocommerce-tabs wc-tabs-wrapper bg-lighter wc-tab-style-two d-none">
            <div class="container">
    ...
    <div class="axil-new-arrivals-product-area fullwidth-container flash-sale-area section-gap-80-35">
        <div class="container ml--xxl-0">
            <div class="section-title-border slider-section-title">
                <h2 class="title">You Mignt Also Like 💥</h2>
            </div>
    ...
    <div class="service-area axil-section-gapcommon d-none">
        <div class="container">
            <div class="section-title-wrapper section-title-border">

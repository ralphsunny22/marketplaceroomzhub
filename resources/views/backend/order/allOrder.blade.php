        ...
        <div class="row d-none">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{ucFirst($status)}} Orders</h4>
                </div>
            </div>
        </div>
        <!-- start page title -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4">
                            This shows the list of {{ucFirst($status)}} Orders.
                        </p>
                                            ...
                                            <tr>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @foreach ($allStatus as $status)
                                                                <a class="dropdown-item {{ $item->status == $status['name'] ? 'd-none' : '' }}"
                                                                    {{-- href="{{ route('adminUpdateOrderstatus', ['id' => $item->id, 'status' => $status['name']]) }}" --}}
                                                                >
                                                                    {{ ucFirst($status['name']) }}
                                                                </a>
                                                            @endforeach
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-space-between align-items-center">
                                                        ...
                                                        <a
                                                        href="{{ route('orderDetail', $item->id) }}"

            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{route('editCategoryPost', $category->id)}}" method="POST" enctype="multipart/form-data">@csrf
                                    ...
                                    <div class="mb-3">
                                        <img src="{{$category->featured_logo}}" alt="Featured Logo" style="width: 100px; height: 100px; border-radius: 5px;">
                                    </div>
